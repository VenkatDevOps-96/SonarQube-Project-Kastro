pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USERNAME = 'venky96'  // Set this directly to your Docker Hub username
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/VenkatDevOps-96/SonarQube-Project-Kastro.git'
            }
        }
